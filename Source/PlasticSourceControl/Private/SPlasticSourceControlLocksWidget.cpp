	...
	[
		...
		[
			...
			[
				...
				.AutoWidth()
				[
					// TODO Button to Configure Lock Rules in the cloud
					// (for cloud repository only)
					SNew(SButton)
					.ContentPadding(FMargin(6.0f, 0.0f))
					.ToolTipText(LOCTEXT("PlasticLockRulesURLTooltip", "Navigate to lock rules configuration page in the Unity Dashboard."))
#if ENGINE_MAJOR_VERSION == 5 && ENGINE_MINOR_VERSION >= 1
					...
					.IsEnabled_Lambda([OrganizationName] { return !OrganizationName.IsEmpty(); })
					[
						SNew(SHorizontalBox)
						+SHorizontalBox::Slot()
						.AutoWidth()
